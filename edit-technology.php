...
if (!isset($_GET['eid']) || empty($_GET['eid'])) {
    header("location:display-technology.php");
}

$selectq = mysqli_query($connection, "select * from tbl_product where pro_id='{$editid}'") or dir(mysqli_error($connection));
...
if ($_POST) {
    ...
    if ($query) {
        echo "<script>alert('Record Updated');window.location='display-technology.php';</script>";
    }
}
...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="forms">
                    <h2 class="title1">Technology Form</h2>
                    ...
                    <div class=" form-grids row form-grids-right">
                        <div class="widget-shadow " data-example-id="basic-forms">
                            ...
                            <div class="form-title">
                                <h4>Edit Technology Information :</h4>
                            </div>
                            <div class="form-body">
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['pro_name'] ?>" name="pname" placeholder="Enter Product Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Product Price</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['pro_price'] ?>" name="pprice" placeholder="Enter Product Price">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-2">
                                        ...
                                        <button type="button" onclick="window.location='display-technology.php';" class="btn btn-info">View</button>
                                    </div>
                                </form>
                            </div>
                        </div>
