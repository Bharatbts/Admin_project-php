...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <h2 class="title1">Technology Table</h2>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['did'])) {
                                    ...
                                    if ($deleteq) {
                                        echo "<scrip>alert('Record Deleted')</script>";
                                    }
                                }
                                ...
                                while ($productrow = mysqli_fetch_array($selectq)) {
                                    ...
                                    echo "<td>{$productrow['pro_details']}</td>";
                                    echo "<td><a href='edit-technology.php?eid={$productrow['pro_id']}'><img style= 'width: 17px'; src='myimages/edit-icon.png'>Edit</a> |  <a href='display-technology.php?did={$productrow['pro_id']}' onclick='return confirmDelete()'><img style='width: 17px'; src='myimages/delete-icon.png'>Delete</a></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
