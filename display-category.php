...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <h2 class="title1">Category Table</h2>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                while ($categoryrow = mysqli_fetch_array($selectq)) {
                                    ...
                                    echo "<td><a href='edit-category.php?eid={$categoryrow['category_id']}'><img style= 'width: 17px'; src='myimages/edit-icon.png'>Edit</a> |  <a href='display-category.php?did={$categoryrow['category_id']}' onclick='return confirmDelete()'><img style='width: 17px'; src='myimages/delete-icon.png'>Delete</a></td>";
                                    echo "</tr>";
                                }
                                ?>
