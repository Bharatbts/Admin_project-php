...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "insert into tbl_user(user_name,user_email,user_gender,user_password,user_mobile,user_address) 
    values('{$name}','{$email}','{$gender}','{$password}','{$mobile}','{$address}')");
                            ...
                            <div class="form-body">
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-offset-2">
                                        ...
                                        <button type="reset" onclick="window.location='display-user.php';" class="btn btn-info">View</button>
                                    </div>
                                </form>
                            </div>
                        </div>
