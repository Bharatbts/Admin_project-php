                            ...
                            <div class="form-body">
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="cid" placeholder="Category Id" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="col-sm-offset-2">
                                        ...
                                        <button type="reset" onclick="window.location='display-category.php';" class="btn btn-info">View</button>
                                    </div>
                                </form>
                            </div>
                        </div>
