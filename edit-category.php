...
$selectq = mysqli_query($connection, "select * from tbl_category where category_id='{$editid}'") or dir(mysqli_error($connection));
...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "insert into tbl_category(category_id,category_name) values('{$cid}','{$cname}')");
    if ($query) {
                            ...
                            <div class="form-body">
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="cid" value="<?php echo $selectrow['category_id'] ?>" placeholder="Category Id" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-2 control-label">Category Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="cname" value="<?php echo $selectrow['category_name'] ?>" placeholder="Category Name" required>
                                        </div>
                                    </div>
