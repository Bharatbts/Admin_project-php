...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "insert into tbl_feedback(user_id,feedback_details,feedback_date) 
    values('{$uid}','{$details}','{$date}')");
                            ...
                            <div class="form-body">
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="uid" placeholder="Enter Id" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Details</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="details" placeholder="Please fill details..."></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
